# Generated by Django 4.2.9 on 2024-01-13 10:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('filters_manager', '0011_alter_article_sizes'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='article',
            name='colors',
            field=multiselectfield.db.fields.MultiSelectField(choices=[('BLACK', 'BLACK'), ('WHITE', 'WHITE'), ('GREY', 'GREY'), ('BLUE', 'BLUE'), ('GREEN', 'GREEN'), ('YELLOW', 'YELLOW'), ('PURPLE', 'PURPLE')], max_length=70),
        ),
        migrations.AlterField(
            model_name='article',
            name='sizes',
