...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('filters_manager', '0003_article_colors_article_sizes_alter_filter_price_max_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='article',
            name='colors',
            field=models.JSONField(choices=[('BLACK', 'BLACK'), ('WHITE', 'WHITE'), ('GREY', 'GREY'), ('BLUE', 'BLUE'), ('GREEN', 'GREEN'), ('YELLOW', 'YELLOW'), ('PURPLE', 'PURPLE')], default=dict),
        ),
        migrations.AlterField(
            model_name='article',
            name='sizes',
